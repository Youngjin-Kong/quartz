...
- 머신 노트 **110개** (완료 84 / 부분 3 / 미완 23)
- 기법 태그 **92종**, 총 1313개 부착
- CVE **209종** 색인
...
- **리버스 셸** (84) `#tech/payload/revshell`
- **SMB 열거** (65) `#tech/svc/smb`
- **해시 크랙** (55) `#tech/cred/crack`
- **디렉터리 브루트포스** (47) `#tech/enum/dirbust`
- **LFI / RFI / 경로탐색** (46) `#tech/web/lfi-rfi`
- **WinRM (5985)** (43) `#tech/exec/winrm`
- **sudo 오설정** (36) `#tech/lin/sudo-abuse`
- **searchsploit** (34) `#tech/enum/searchsploit`
- **msfvenom** (32) `#tech/payload/msfvenom`
- **BloodHound 열거** (31) `#tech/ad/bloodhound`
- **DCSync / secretsdump** (28) `#tech/ad/dcsync`
- **linPEAS / winPEAS** (28) `#tech/enum/peas`
- **SSH 키** (28) `#tech/exec/ssh-key`
- **패스워드 스프레이** (26) `#tech/cred/spray`
