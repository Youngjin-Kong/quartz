...
- 머신 노트 **95개** (완료 69 / 미완 26)
- 기법 태그 **70종**, 총 1204개 부착
- CVE **156종** 색인
...
- **리버스 셸** (67) `#tech/payload/revshell`
- **SMB 열거** (65) `#tech/svc/smb`
- **해시 크랙** (52) `#tech/cred/crack`
- **LFI / RFI / 경로탐색** (51) `#tech/web/lfi-rfi`
- **디렉터리 브루트포스** (50) `#tech/enum/dirbust`
- **WinRM (5985)** (43) `#tech/exec/winrm`
- **sudo 오설정** (34) `#tech/lin/sudo-abuse`
- **searchsploit** (31) `#tech/enum/searchsploit`
- **msfvenom** (31) `#tech/payload/msfvenom`
- **linPEAS / winPEAS** (30) `#tech/enum/peas`
- **DCSync / secretsdump** (29) `#tech/ad/dcsync`
- **BloodHound 열거** (29) `#tech/ad/bloodhound`
- **SSH 키** (26) `#tech/exec/ssh-key`
- **passwd/shadow 접근** (25) `#tech/lin/passwd-write`
- **SeImpersonate 권한** (24) `#tech/win/seimpersonate`