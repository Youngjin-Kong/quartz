...
- 머신 노트 **143개** (완료 114 / 부분 5 / 미완 24)
- 기법 태그 **122종**, 총 2202개 부착
- CVE **193종** 색인
- 이론 노트 708개 중 **0개가 빈 껍데기**
...
- **리버스 셸** (147) `#tech/payload/revshell`
- **SMB 열거** (91) `#tech/svc/smb`
- **해시 크랙** (87) `#tech/cred/crack`
- **디렉터리 브루트포스** (73) `#tech/enum/dirbust`
- **LFI / RFI / 경로탐색** (72) `#tech/web/lfi-rfi`
- **WinRM (5985)** (58) `#tech/exec/winrm`
- **searchsploit** (56) `#tech/enum/searchsploit`
- **sudo 오설정** (48) `#tech/lin/sudo-abuse`
- **msfvenom** (48) `#tech/payload/msfvenom`
- **BloodHound 열거** (42) `#tech/ad/bloodhound`
- **passwd/shadow 접근** (42) `#tech/lin/passwd-write`
- **linPEAS / winPEAS** (41) `#tech/enum/peas`
- **SSH 키** (41) `#tech/exec/ssh-key`
- **Mimikatz / LSASS** (41) `#tech/cred/mimikatz`
- **DCSync / secretsdump** (39) `#tech/ad/dcsync`