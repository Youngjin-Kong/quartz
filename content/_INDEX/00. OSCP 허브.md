...
- 머신 노트 **119개** (완료 93 / 부분 4 / 미완 22)
- 기법 태그 **99종**, 총 1389개 부착
- CVE **215종** 색인
...
- **리버스 셸** (91) `#tech/payload/revshell`
- **SMB 열거** (67) `#tech/svc/smb`
- **해시 크랙** (56) `#tech/cred/crack`
- **디렉터리 브루트포스** (52) `#tech/enum/dirbust`
- **LFI / RFI / 경로탐색** (48) `#tech/web/lfi-rfi`
- **WinRM (5985)** (43) `#tech/exec/winrm`
- **sudo 오설정** (38) `#tech/lin/sudo-abuse`
- **searchsploit** (36) `#tech/enum/searchsploit`
- **msfvenom** (33) `#tech/payload/msfvenom`
- **BloodHound 열거** (31) `#tech/ad/bloodhound`
- **SSH 키** (30) `#tech/exec/ssh-key`
- **DCSync / secretsdump** (28) `#tech/ad/dcsync`
- **linPEAS / winPEAS** (28) `#tech/enum/peas`
- **패스워드 스프레이** (26) `#tech/cred/spray`
- **파일 업로드** (26) `#tech/web/file-upload`