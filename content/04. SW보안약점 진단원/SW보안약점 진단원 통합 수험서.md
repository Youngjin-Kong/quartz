...
> ⛔ **이 장의 15일 일정표(Phase 1~4)는 1차(2026-08-08) 대비용으로 만료됨.** 현행 플랜은 [[2차 대비 D-64 학습 플랜]] — 2차 시험일 **2026-10-31(토)** 기준. 아래 「공식 시험 정보」 표(시간·문항·배점·과락·가중치)와 유의사항은 그대로 유효하나, **날짜가 박힌 일정·체크포인트는 무시할 것.**
