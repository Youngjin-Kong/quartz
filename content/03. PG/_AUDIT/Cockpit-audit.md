...
(2026-08-20 이관 — 원래 `Cockpit.md` 프론트매터 직후 상단에 있던 블록. 원문 그대로.)
...
### 「남긴 흔적」 절(본문 661행)에서 잘라낸 절

(2026-08-20 이관. 이관 보고에는 원문이 인용돼 있지 않아, 별도 감사자가 되살릴 수 있도록 여기 남긴다.)
...
잘라낸 것은 「검증 시점에 감사자가 교차 확인했다 — 」 절뿐이다. journald 시각 두 개·`install`/`rm` 명령·`/etc/sudoers.d/` 배포 기본 4개라는 사실 서술은 본문에 그대로 남았다.
